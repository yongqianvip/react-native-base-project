...
//   });
//   componentDidMount() {
//     console.log("---- this.props.navigation",this.props.router);
//   }
//   render() {
...
//         <Button onPress={() => {
//           navigation && navigation.goBack && navigation.navigate('Temp2Screen')
//         }}
//                 title="To Temp 2"/>
//         <Button onPress={() => {
//           navigation && navigation.goBack && navigation.goBack('DetailsScreen')
//         }}
//                 title="Go Back"/>
//         <Button onPress={() => {
//           NativeModules.FullScreen.close()
//         }}
//                 title="hide top window "/>
//       </View>
//     );
//   }
// }

// export default connect()(TempScreen)
